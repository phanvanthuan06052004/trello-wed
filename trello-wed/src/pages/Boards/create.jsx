 ...
 */
function SidebarCreateBoardModal({ reloadPage }) {
  ...
  const submitCreateNewBoard = (data) => {
    ...
    createNewBoardAPI(data).then(() => {
      handleCloseModal() // Đóng Modal sau khi tạo board thành công
      reloadPage() // Gọi hàm reloadPage để cập nhật lại danh sách boards
    })
  }
